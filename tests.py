...
from utils import crack, find_folder_patterns
...
class UtilsTest(unittest.TestCase):
    ...
    def test_find_alternate_paths(self):
        ...
        self.assertEqual(sorted(list(alts.keys())), ['002FD1C467166E5E', '0030A0D22171B48E', '00358562D91EA649', '003ECCF5A8D38451', '0057B95F2B255C6D', '005FEB95C8C99832', '006303F1C897C52D', '007DC73458526F0C', '008A3519919395F0', '00AC89D978CBF4DC', '00E3C72FE24E4993', '00FD535D8C65CDB5'])
    ...
    #     # self.assertEqual(sorted(words), ['29', '9m', 'a', 'abandoned', 'assembly', 'building', 'data', 'environment', 'fox', 'inner', 'kit', 'levels', 'me', 'mere', 'paint', 'pc', 'pro', 'resources', 'run', 'runtimeresources', 'sources', 'templates', 'ti', 'time', 'vertex', 'vertexdata', 'vertexpaint', 'wall'])

    #     words = extract_words('[assembly:/_pro/facefx/exported_animation/english(us)/ancestral/bulldog/41000_story/dr41147_murderpi47andbutlerasktoseecrimescenebehind_bulldog_butler_m_002.animset].pc_animset')
    ...
    def test_find_folder_patterns(self):
        paths: list[str] = [
            '[assembly:/_pro/environment/materials/generic/t1',
            '[assembly:/_pro/environment/materials/generic/t2',
        ]
        found_patterns = find_folder_patterns(paths)
        self.assertEqual(len(found_patterns), 1)
        self.assertEqual(found_patterns.pop(), '[assembly:/_pro/environment/materials/generic/*/')

        paths: list[str] = [
            '[assembly:/_pro/environment/materials/t1/f1',
            '[assembly:/_pro/environment/materials/t2/f2',
        ]
        found_patterns = find_folder_patterns(paths, max_wildcards=2)
        self.assertEqual(len(found_patterns), 1)
        self.assertEqual(found_patterns.pop(), '[assembly:/_pro/environment/materials/*/*/')
